...
/**
 * Photopipe mark. Ink follows `currentColor`; the accent reads the
 * `--pp-accent` custom property and falls back to #FF7A2F.
 *
 *   <Photopipe className="h-8 w-8 text-zinc-900 dark:text-white" />
 */
